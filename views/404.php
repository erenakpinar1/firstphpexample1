            ...
            <div class="outer">
                <div class="middle">
                    <div class="inner">
                        ...
                        <span class="inner-status" style="color:#fff;">Hata! Sayfa bulunamadı</span>
                        <br />
                        <span class="inner-detail" style="color:#fff;">
                                Ya aradığını bulamadık, ya da teknik bi arızaya yakalandın. <br /> Çerezlerini temizlemeyi dene
                                <br />
                                <br />
                                <a href="../index.php?route=Person" class="btn btn-info mtl center-block" style="background-color:#fff; color:#71437F; font-weight:bold; border:none;">
...
<style>
    ...
    .page-404 .outer .middle .inner .inner-circle:hover i {
        color: #71437F!important;
        background-color: #f5f5f5;
        box-shadow: 0 0 0 15px #71437F;
    }
